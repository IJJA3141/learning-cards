...
namespace QzCPP {
	...
	private:
		...
		void InitializeMyComponent(void)
		{
			...
			this->Menu->Padding = System::Windows::Forms::Padding(0, 0, 0, 0);
			this->Menu->TabStop = false;
			this->Menu->Name = L"Menu";
			this->Menu->MouseEnter += gcnew System::EventHandler(this, &QzCPP::MainPage::scrollBarMouseLeave);

			// scrollBar
			this->scrollBar->Size = System::Drawing::Size(12, MainWindowHeight);
			...
			this->scrollBar->MouseEnter += gcnew System::EventHandler(this, &QzCPP::MainPage::scrollBarMouseEnter);
			...
			this->handle->Location = System::Drawing::Point(MainWindowWidth - this->scrollBar->Width + (this->scrollBar->Width - this->handle->Width) / 2, 0);
			...
			this->handle->Click += gcnew System::EventHandler(this, &QzCPP::MainPage::handleClick);
			this->handle->MouseDown += gcnew System::Windows::Forms::MouseEventHandler(this, &MainPage::onButtonMouseDown);
